        ...
        security.cors(Customizer.withDefaults())
            ...
            .authorizeHttpRequests { requests ->
                requests
                    ...
                    .requestMatchers(antMatcher(HttpMethod.POST, "/orders")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/orders")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/orders/{id}")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/orders/identifyCode")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.PUT, "/orders//{id}")).authenticated()
