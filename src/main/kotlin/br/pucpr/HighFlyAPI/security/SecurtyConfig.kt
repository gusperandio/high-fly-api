        ...
        security.cors(Customizer.withDefaults())
            ...
            .authorizeHttpRequests { requests ->
                requests
                    ...
                    .requestMatchers(antMatcher(HttpMethod.GET, "/order")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/order/{id}")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/order/{identifyCode}")).authenticated()
                    .requestMatchers(antMatcher(HttpMethod.PUT, "/order/{identifyCode}")).authenticated()
